...
void executar_instancia(Clausula clausulas[], int num_vars, int num_clausulas) {
    ...
    printf("Busca Local: Melhor Pontuação = %d, Tempo = %.4f segundos\n", melhor_score_bl, tempo_bl);
    printf("Melhor solucao: ");
    imprimir_solucao(melhor_solucao_bl, num_vars);

    printf("Algoritmo Genético: Melhor Pontuação = %d, Tempo = %.4f segundos\n", melhor_score_ag, tempo_ag);
    printf("Melhor solucao: ");
